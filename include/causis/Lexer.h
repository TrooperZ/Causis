...
private:
  ...
  inline static const std::unordered_map<std::string, TokenType> _keywords = {
      ...
      {"bool", TokenType::KwBool},     {"Bool", TokenType::KwBool},
      {"string", TokenType::KwString}, {"String", TokenType::KwString},
      {"Int", TokenType::KwInt},       {"int32", TokenType::KwInt32},
      {"uint8", TokenType::KwUint8},   {"int8", TokenType::KwInt8},
      {"uint16", TokenType::KwUint16}, {"int16", TokenType::KwInt16},
      {"uint32", TokenType::KwUint32}, {"uint64", TokenType::KwUint64},
      {"int64", TokenType::KwInt64},   {"float32", TokenType::KwFloat32},
